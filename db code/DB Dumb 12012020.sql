...
--
-- Host: 35.231.101.83    Database: Campus_Eats_Fall2020
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '5275787a-1f8c-11eb-8e84-42010a8e0054:1-452126';
...
CREATE TABLE `driver_rating` (
  ...
  KEY `fk_driver_driver_id_idx` (`driver_id`),
  KEY `fk_person_person_id_idx` (`person_id`),
  CONSTRAINT `fk_drating_driver_id` FOREIGN KEY (`driver_id`) REFERENCES `driver` (`driver_id`),
  CONSTRAINT `fk_drating_person_id` FOREIGN KEY (`person_id`) REFERENCES `person` (`person_id`)
...
INSERT INTO `driver_rating` VALUES (1,54,7,1),(2,148,6,4),(3,98,8,5),(4,35,1,5),(5,115,2,1),(6,126,1,4),(7,188,6,3),(8,181,6,3),(9,171,4,5),(10,137,3,1),(11,6,7,4),(12,148,4,2),(13,15,5,5),(14,35,6,1),(15,32,1,1),(16,189,5,4),(17,196,8,4),(18,163,4,4),(19,156,1,1),(20,17,7,2),(21,21,2,3),(22,72,8,2),(23,41,3,3),(24,71,5,5),(25,67,3,1),(26,95,3,5),(27,179,8,2),(28,122,4,3),(29,65,1,2),(30,128,4,5),(31,189,2,1),(32,88,7,5),(33,102,4,4),(34,93,6,4),(35,22,2,1),(36,55,3,5),(37,196,8,4),(38,195,6,5),(39,182,5,5),(40,75,1,3),(41,82,7,4),(42,47,6,5),(43,96,3,5),(44,125,1,2),(45,181,6,1),(46,170,8,1),(47,135,6,1),(48,183,1,5),(49,86,7,2),(50,112,2,3),(51,38,7,5),(52,138,1,2),(53,172,6,1),(54,148,5,5),(55,115,7,4),(56,34,3,1),(57,46,3,1),(58,122,4,4),(59,68,8,3),(60,20,7,3),(61,141,3,2),(62,199,5,1),(63,125,3,3),(64,44,6,1),(65,8,3,3),(66,157,4,5),(67,133,6,4),(68,95,2,4),(69,179,2,2),(70,7,3,5),(71,23,3,1),(72,134,6,1),(73,28,5,5),(74,27,7,4),(75,141,6,4),(76,92,3,2),(77,131,4,5),(78,169,6,3),(79,141,5,4),(80,199,7,3),(81,192,5,1),(82,115,2,5),(83,133,2,4),(84,130,5,4),(85,141,6,4),(86,82,2,3),(87,8,7,2),(88,40,1,1),(89,106,2,5),(90,26,6,5),(91,120,7,4),(92,147,8,4),(93,60,3,3),(94,87,2,2),(95,86,3,3),(96,43,2,5),(97,145,8,5),(98,193,1,2),(99,138,4,5),(100,49,6,2);
...
INSERT INTO `restaurant_rating` VALUES (1,179,8,4),(2,23,2,4),(3,41,6,4),(4,130,1,2),(5,40,1,5),(6,174,7,1),(7,142,6,4),(8,133,8,2),(9,17,4,1),(10,21,7,1),(11,91,8,5),(12,193,8,4),(13,188,7,2),(14,11,4,5),(15,28,1,1),(16,194,4,3),(17,107,1,2),(18,132,8,1),(19,133,5,5),(20,153,6,4),(21,68,1,3),(22,133,8,1),(23,140,5,1),(24,74,1,1),(25,154,8,2),(26,65,3,1),(27,105,5,1),(28,163,1,4),(29,177,2,3),(30,191,1,1),(31,29,1,2),(32,155,8,2),(33,65,1,1),(34,82,1,1),(35,41,4,5),(36,73,6,1),(37,65,4,2),(38,20,3,5),(39,200,8,5),(40,38,7,3),(41,113,1,3),(42,144,4,2),(43,11,8,2),(44,185,1,3),(45,126,7,3),(46,199,6,1),(47,132,7,1),(48,118,6,1),(49,91,7,4),(50,125,2,5),(51,149,4,3),(52,49,2,4),(53,94,8,4),(54,13,8,5),(55,46,5,4),(56,96,6,3),(57,120,2,5),(58,72,2,1),(59,198,1,5),(60,176,4,4),(61,9,3,3),(62,164,4,4),(63,78,2,5),(64,96,3,1),(65,110,1,5),(66,164,5,2),(67,113,6,4),(68,31,1,5),(69,45,5,1),(70,178,2,3),(71,196,4,2),(72,120,3,1),(73,5,1,5),(74,173,4,3),(75,191,2,2),(76,17,7,1),(77,15,2,1),(78,113,3,5),(79,199,2,1),(80,181,2,1),(81,136,6,2),(82,136,8,2),(83,179,4,2),(84,86,1,3),(85,179,4,4),(86,10,4,1),(87,191,5,3),(88,99,3,1),(89,74,6,1),(90,76,4,1),(91,19,4,4),(92,125,4,4),(93,105,2,5),(94,120,1,5),(95,43,5,4),(96,40,8,5),(97,193,5,2),(98,137,2,4),(99,63,7,1),(100,175,4,2);
...
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `driver_rating`(IN d_id INT(11))
BEGIN
	SELECT person_name,dr.driver_id,orders,AVG(stars) AS rating
    FROM driver_rating AS dr
    JOIN driver ON dr.driver_id = driver.driver_id
    JOIN student ON driver.student_id = student.student_id
    JOIN person ON student.person_id = person.person_id
    JOIN (SELECT driver_id,COUNT(order_id) AS orders FROM `order` GROUP BY driver_id) 
		AS order_count ON order_count.driver_id = dr.driver_id
    GROUP BY dr.driver_id
    HAVING dr.driver_id = d_id
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `restaurant_rating`(IN r_id INT(11))
BEGIN
	SELECT restaurant_name,rr.restaurant_id,location,orders,AVG(stars) AS rating
    FROM restaurant_rating AS rr
    JOIN restaurant ON rr.restaurant_id = restaurant.restaurant_id
    JOIN (SELECT restaurant_id,COUNT(order_id) AS orders FROM `order` GROUP BY restaurant_id) 
		AS order_count ON order_count.restaurant_id = rr.restaurant_id
    GROUP BY rr.restaurant_id
    HAVING rr.restaurant_id = r_id
    ORDER BY rating DESC;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
-- Dump completed on 2020-12-01 17:35:20
